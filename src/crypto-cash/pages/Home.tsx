        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-20 md:pt-32 pb-16 md:pb-24 text-center">
          ...
          {lang === "en" && (
            <div className="mx-auto mt-10 w-full max-w-4xl">
              <div className="aspect-video w-full overflow-hidden rounded-2xl border border-border/60 bg-surface/50 shadow-2xl">
                <iframe
                  src="https://www.youtube.com/embed/eG-mRwZO368"
            ...
            <div className="mx-auto mt-10 w-full max-w-4xl">
              <div className="aspect-video w-full overflow-hidden rounded-2xl border border-border/60 bg-surface/50 shadow-2xl">
                <iframe
                  ...
                  title="Presentazione di Crypto Cash"
                  allow="accelerometer; clipboard-write; encrypted-media; fullscreen; gyroscope; picture-in-picture; web-share"
                  allowFullScreen
                  width="100%"
                  height="100%"
          ...
          {lang === "pl" && (
            <div className="mx-auto mt-10 w-full max-w-4xl">
              <div className="aspect-video w-full overflow-hidden rounded-2xl border border-border/60 bg-surface/50 shadow-2xl">
                <iframe
                  src="https://www.youtube.com/embed/4JW_mbJkuDM"
                  title="Prezentacja Crypto Cash"
                  allow="accelerometer; clipboard-write; encrypted-media; fullscreen; gyroscope; picture-in-picture; web-share"
                  allowFullScreen
                  width="100%"
                  height="100%"
          ...
          {lang === "fr" && (
            <div className="mx-auto mt-10 w-full max-w-4xl">
              <div className="aspect-video w-full overflow-hidden rounded-2xl border border-border/60 bg-surface/50 shadow-2xl">
                <iframe
                  src="https://www.youtube.com/embed/dfqH_KiX4ms"
                  title="Présentation vidéo de Crypto Cash"
                  allow="accelerometer; clipboard-write; encrypted-media; fullscreen; gyroscope; picture-in-picture; web-share"
                  allowFullScreen
                  width="100%"
                  height="100%"
